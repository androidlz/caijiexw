package com.seventeenok.caijie.constant;
...
public class BundleKeyConstant {
    public static final String ARG_KEY_TAB_HOME_FRAGMENT_CATE_ID 
            = "arg_key_tab_home_fragment_cate_id";
    public static final String ARG_KEY_TAB_HOME_FRAGMENT_CATE_NAME 
            = "arg_key_tab_home_fragment_cate_name";
